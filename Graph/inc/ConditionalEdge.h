...
namespace Cyclebite::Graph
{
     ...
     * It has the same structure as UnconditionalEdge because we are only interested in structuring the edges we observe, not the static instructions underneath

...
namespace TraceAtlas::Grammar
{
    ...
    /// "input(y+k, x+l, c) * kernel(k, l)" is an TraceAtlas::Grammar::Expression
    /// "input(y+k, x+l, c)" and "kernel(k, l)" are TraceAtlas::Grammar::Collections
    class Expression : public Symbol
    {
    public:
        Expression( const std::vector<std::shared_ptr<Symbol>>& s, const std::vector<TraceAtlas::Graph::Operation>& o );
        ~Expression() = default;
    ...
    protected:
        ...
        std::vector<TraceAtlas::Graph::Operation> ops;
